            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="exampleInputName" placeholder="Nama Mata Pelajaran" name="nama" value="{{old('nama')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="replyNumber" min="0" data-bind="value:replyNumber"  class="form-control @error('no_urut') is-invalid @enderror" placeholder="Urutan pada rapor" name="no_urut" value="{{old('no_urut')}}">
